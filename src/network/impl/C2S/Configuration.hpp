...
namespace Packet {
    ...
    char *ClientInformation(const char *locale, int8_t view_distance, ChatMode chat_mode, bool chat_colors,
                            DisplayedSkinPart displayed_skin_part, MainHand main_hand, bool enable_text_filtering,
